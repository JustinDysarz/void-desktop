...
static const char *fonts[]          = { "Terminus:size=13", "Hack:size=13", "monospace:size=13" };
...
static const char col_blue1[]       = "#005577"; //#005577
static const char col_blue2[]       = "#007f99"; //#007f99
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_m,      spawn,          {.v = mail} },
   	...
   	{ MODKEY|ShiftMask,             XK_n,      spawn,          {.v = emacs } },
   	...
   	{ Mod1Mask|ShiftMask,           XK_l,      spawn,          SHCMD("xlock") },
